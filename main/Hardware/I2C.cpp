...
int I2C::endTransaction() {
	i2c_master_stop(cmd);
   // int ret=i2c_master_cmd_begin(I2C_NUM_0, cmd,1000/portTICK_PERIOD_MS); //made problems in esp-idf 3.0
    int ret=i2c_master_cmd_begin(I2C_NUM_0, cmd,10/portTICK_PERIOD_MS);
